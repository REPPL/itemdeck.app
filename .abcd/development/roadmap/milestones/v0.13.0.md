...
|----|---------|------------|--------|
| WP-A | Plugin Core Infrastructure (schemas, loader, cache, security, validation) | Large | ✅ Complete |
| WP-B | Plugin Migration (adapters, themes, mechanics, sources) | Large | ✅ Complete |
| WP-C | User Documentation (tutorials, guides) | Medium | 📋 Planned |
| WP-D | Plugin Discovery UI (browser, manager) | Medium | 📋 Planned |
| WP-E | Developer Documentation & ADRs | Medium | 📋 Planned |
...
| ID | Feature | Reason |
|----|---------|--------|
| [F-059](../features/completed/F-059-competing-mechanic.md) | Competing Mechanic | ✅ Completed in v0.14.0 |
| [F-060](../features/completed/F-060-quiz-mechanic.md) | Quiz Mechanic | ✅ Completed in v0.14.0 |
