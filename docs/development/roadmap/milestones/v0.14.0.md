...
| F-092 | Cache Consent Dialog UX | Small | 📋 Planned |
| F-093 | Mechanic Panel: Hide Active from List | Small | 📋 Planned |
| F-094 | Button Style Consistency Audit | Medium | 📋 Planned |
...
- [ ] All mechanics implemented and playable
