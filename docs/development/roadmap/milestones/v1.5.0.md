...
|----|---------|----------|------------|
| F-110 | Plugin Manifest Schema | Critical | Medium |
| F-111 | Plugin Loader & Registry | Critical | High |
| F-112 | Plugin Security Sandbox | Critical | High |
| F-113 | Plugin Permission Model | High | Medium |

### Plugin Types

| ID | Feature | Priority | Complexity |
|----|---------|----------|------------|
| F-114 | Settings Schema Plugins | High | Medium |
| F-115 | Theme Package Plugins | High | Medium |
| F-116 | Mechanic Plugins (External) | High | High |
| F-117 | Source Adapter Plugins | Medium | High |

### Distribution System

| ID | Feature | Priority | Complexity |
|----|---------|----------|------------|
| F-118 | Built-in Plugin Bundling | High | Medium |
| F-119 | Curated Registry API | Medium | High |
| F-120 | Community Plugin Loading | Medium | High |
| F-121 | Plugin Activation UI | High | Medium |
...
- [ ] Research: state-of-the-art-plugin-architecture.md
- [ ] Research: state-of-the-art-web-security-sandbox.md
- [ ] ADR: Plugin Architecture
- [ ] ADR: Plugin Security Model
- [ ] ADR: Plugin Distribution Strategy
- [ ] Feature specs: F-110 to F-121
...
- [Plugin Architecture Research](../../research/state-of-the-art-plugin-architecture.md) (to create)
- [Plugin Security Research](../../research/state-of-the-art-web-security-sandbox.md) (to create)
