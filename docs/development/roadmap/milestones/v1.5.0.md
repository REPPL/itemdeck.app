...
|----|---------|----------|------------|
| F-122 | Plugin Manifest Schema | Critical | Medium |
| F-123 | Plugin Loader & Registry | Critical | High |
| F-124 | Plugin Security Sandbox | Critical | High |
| F-125 | Plugin Permission Model | High | Medium |

### Plugin Types

| ID | Feature | Priority | Complexity |
|----|---------|----------|------------|
| F-126 | Settings Schema Plugins | High | Medium |
| F-127 | Theme Package Plugins | High | Medium |
| F-128 | Mechanic Plugins (External) | High | High |
| F-129 | Source Adapter Plugins | Medium | High |

### Distribution System

| ID | Feature | Priority | Complexity |
|----|---------|----------|------------|
| F-130 | Built-in Plugin Bundling | High | Medium |
| F-131 | Curated Registry API | Medium | High |
| F-132 | Community Plugin Loading | Medium | High |
| F-133 | Plugin Activation UI | High | Medium |
